...
'2. ترحيب مهم: إذا ألقى العميل التحية أو قال كلمات ترحيبية (مثل: مرحبا، السلام عليكم، هلو، صبّحكم الله بالخير)، رحب به بلباقة شديدة وعرّف بنفسك كمساعد ذكي لشركة SAI وأبدي استعدادك الكامل لمساعدته في تفاصيل العقد أو الخدمات.\n' +
  ...
  history.forEach(h => {
    if (h && h.content && (h.role === 'user' || h.role === 'assistant')) {
      contents.push({
        ...
        parts: [{ text: String(h.content).slice(0, MAX_MESSAGE_LEN) }]
      });
    }
  });
